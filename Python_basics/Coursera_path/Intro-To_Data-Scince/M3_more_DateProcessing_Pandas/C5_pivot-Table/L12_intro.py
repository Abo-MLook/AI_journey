...
print()
#first solution
bins = [0,100,200,300,df['world_rank'].max()]
labl = ["First Tier Top Unversity","Second Tier Top Unversity","Third Tier Top Unversity","Other Top Unversity"]
df['Rank_Level'] = pd.cut(df['world_rank'], bins=bins, labels=labl)
print(df.head())
